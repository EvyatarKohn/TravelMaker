...
class CustomCitiesListDialog: DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val v = inflater.inflate(R.layout.custom_cities_list_layout, container, false)
        ...
        mLatWest.addTextChangedListener(object :TextWatcher{
        ...
        mLongNorth.addTextChangedListener(object :TextWatcher{
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                mError.visibility = View.INVISIBLE
            }
        ...
        mLatEast.addTextChangedListener(object :TextWatcher{
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                mError.visibility = View.INVISIBLE
            }
        ...
        mLongSouth.addTextChangedListener(object :TextWatcher{
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                mError.visibility = View.INVISIBLE
            }
