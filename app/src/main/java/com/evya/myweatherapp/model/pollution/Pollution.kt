...
data class Pollution(
    ...
    fun definePollution(): String {
        ...
        if (list[0].components.no2 > 400 || list[0].components.pm10 > 180 ||
            ...
            airPollution = Constants.Pollution.POOR.pollution
            ...
            airPollution = Constants.Pollution.MODERATE.pollution
            ...
            airPollution = Constants.Pollution.FAIR.pollution
